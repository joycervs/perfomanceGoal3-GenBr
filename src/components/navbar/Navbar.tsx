   ...
   return (
    <>
        <div className='flex justify-between flex-row w-full bg-indigo-900 py-2 px-20 text-white font-bold text-2xl'>
            <div>
               <Link className='text-4xl flex items-center gap-4' to='/home'><img className='w-1/5'  src="https://ik.imagekit.io/joyce/farm-icon.webp?updatedAt=1717004027099" alt="Farmacia" /><h1>Farmácia</h1></Link>  
            </div>
